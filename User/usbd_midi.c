...
__ALIGN_BEGIN uint8_t USBD_CDC_CfgFSDesc[101] __ALIGN_END =
{
  /*Configuration Descriptor*/
  0x09,   /* bLength: Configuration Descriptor size */
  USB_DESC_TYPE_CONFIGURATION,      /* bDescriptorType: Configuration */
  0x65,                /* wTotalLength:no of returned bytes */
  0x00,
  ...
  0x00,   /* bcd: MIDI spec release number 1.0*/
  0x01,
  0x09,	  /* wTotalLength */
  0x00,
  0x01,   /* bInCollection */
  ...
  0x09,0x05,MIDI_OUT_EP,0x02,MIDI_DATA_PACKET_SIZE,0x00,0x00,0x00,0x00,
  /* Class-specific Bulk OUT Endpoint Descriptor */
  0x05,0x25,0x01,0x01,0x01,
  
  /* Standard Bulk OUT Endpoint Descriptor */
  0x09,0x05,MIDI_IN_EP,0x02,MIDI_DATA_PACKET_SIZE,0x00,0x00,0x00,0x00,
  /* Class-specific Bulk OUT Endpoint Descriptor */
